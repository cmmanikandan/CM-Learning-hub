...
export const StudentsManager: React.FC = () => {
  const { token } = useAuth();
  const { myStudents, updateMentorNotes } = useApp();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        {/* Toggle Buttons */}
        <div className="flex space-x-1 bg-slate-100 dark:bg-slate-800/40 p-1 rounded-xl self-start sm:self-auto border border-slate-200/50 dark:border-slate-700/50 shadow-sm">
          <button 
